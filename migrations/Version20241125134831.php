 ...
 */
final class Version20241125134831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bonbon (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, gout VARCHAR(255) NOT NULL, ingredients VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, image VARCHAR(255) NOT NULL, poids INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
